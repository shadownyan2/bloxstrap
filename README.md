> [!CAUTION]
> The only official places to  Bloxstrap are this GitHub repository and [bloxstraplabs.com](https://bloxstraplabs.com). Any other websites offering  or claiming to be us are not owned by us.
...
**A:** No. The source code here is viewable to all, and it'd be impossible for us to slip anything malicious into the  without anyone noticing. Just be sure you're downloading it from an official source. The only two official sources are this GitHub repository and [bloxstraplabs.com](https://bloxstraplabs.com).
...
## Installing
 the [latest  of Bloxstrap](https://github.com/bloxstraplabs/bloxstrap//latest), and run it. Configure your preferences if needed, and install. That's about it!

Alternatively, you can install Bloxstrap via [![download button](https://i.imgur.com/3Dm4p65.png)](https://tinyurl.com/yztryhjh) by running this in a Command Prompt window:
```
...
[shield-repo-workflow]: https://img.shields.io/github/actions/workflow/status/bloxstraplabs/bloxstrap/ci-.yml?branch=main&label=builds
[shield-repo-]: https://img.shields.io/github//bloxstraplabs/bloxstrap/latest/total?color=981bfe
[shield-repo-latest]:   https://img.shields.io/github/v//bloxstraplabs/bloxstrap?color=7a39fb
...
[repo-]: https://github.com/bloxstraplabs/bloxstrap/
[repo-latest]:   https://github.com/bloxstraplabs/bloxstrap//latest
